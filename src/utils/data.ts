...
// Obtener toda la informacion de un dato de tipo usuario con el id recibido
export const userQuery = ( userId: string ) => {
    const query = `*[_type == "user" && _id == "${ userId }"]`;
    return query;
}

// Obtener los pins segun la busqueda del usuario
...
// Obtener los pins para el feed del usuario
